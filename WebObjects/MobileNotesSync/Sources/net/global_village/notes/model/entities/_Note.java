// $LastChangedRevision$ DO NOT EDIT.  Make changes to Note.java instead.
...
public abstract class _Note extends  EOGenericRecord {
  ...
  public void setSubject(String value) {
    if (_Note.LOG.isDebugEnabled()) {
    	_Note.LOG.debug( "updating subject from " + subject() + " to " + value);
    }
    takeStoredValueForKey(value, "subject");
  }

  public net.global_village.notes.model.entities.Category category() {
    return (net.global_village.notes.model.entities.Category)storedValueForKey("category");
  }

  public void setCategoryRelationship(net.global_village.notes.model.entities.Category value) {
    if (_Note.LOG.isDebugEnabled()) {
      _Note.LOG.debug("updating category from " + category() + " to " + value);
    }
    if (value == null) {
    	net.global_village.notes.model.entities.Category oldValue = category();
    	if (oldValue != null) {
